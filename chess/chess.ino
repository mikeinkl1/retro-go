...
const unsigned char fig[6][72] PROGMEM={
...
const unsigned char fig_cont[6][72] PROGMEM={
...
void setup() {      
  ...
  M5.Lcd.setRotation(3);        // SCREEN ROTATION = 0  
  definecolors();
  beep(100);      
  ...
  while (millis()-tim<15000) { 
     M5.update();
    if (M5.BtnA.wasPressed()||M5.BtnB.wasPressed()||M5.BtnStart.wasPressed()) {
      beep(100);
      ...
      while (millis()-tim<30000) { 
        M5.update();
        if (M5.BtnA.wasPressed()||M5.BtnB.wasPressed()||M5.BtnStart.wasPressed()) break;
      }
      break;   
    }
  }
